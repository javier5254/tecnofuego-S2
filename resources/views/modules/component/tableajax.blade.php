                                        ...
                                        <div class="row">
                                            <div class="my-auto mx-auto px-4 py-2">
                                                ...
                                                <div class="d-none" id="toprint{{$component->id}}">
                                                    ...
                                                    <small class="mb-0 text-custom" style="align-text:center;">
                                                        {{ $component->name }}
                                                    </small>
                                                    <br>
                                                    {!! QrCode::size(65)->generate(route('component.edit', $component->id)) !!}
                                                ...
                                                <button class="btn btn-secondary text-white d-block center mt-4" href="#"
                                                    onclick="imprimir({{$component->id}})"><i class="fas fa-print"></i> imprimir
                                                    QR </button>
                                            </div>
