<div class="row col-12 m-0 p-0" id="contenendor">
    ...
    @foreach ($components as $component)
        ...
        <div class="card-body border bottom col-12">
            <div class="row">
                <a class="col-sm-8 col-lg-10" href="{{ route('component.edit', $component->id) }}">
                    <h4 style="m-0">
                    ...
                    @forelse ($equipcompo as $ec)
                        @if ($ec->compo_id == $component->id)
                            <small class="text-custom">
                                Equipo : {{ $ec->in }}
                            </small><br>
                        @endif
                ...
                <a class="col-sm-4 col-lg-2 btndynamic" href="#" data-toggle="modal"
                    ...
                    <h5 class="text-center">
                        <small>
                            <small>
                                {{ date('d/m/Y', strtotime($component->created_at)) }}
                            </small>
                            <div class="mt-1">{!! QrCode::size(30)->generate(Request::url('component.edit', $component->id)) !!}</div>
                        </small>
                    </h5>


                </a>
                <div class="modal fade" id="modal-md{{ $component->id }}">
                                        ...
                                        <div class="my-auto mx-auto px-4 py-2">
                                            ...
                                            <div class="d-none" id="toprint{{ $component->id }}">
                                                <div style="width: 5cm;height:2,5cm;">
                                                    ...
                                                    {!! QrCode::size(78)->generate(route('component.edit', $component->id)) !!}&nbsp;&nbsp;
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="91" height="82" viewBox="0 0 91 82">
                                                        <defs>
                                                          <clipPath id="clip-path">
                                                            <rect id="Rectángulo_2" data-name="Rectángulo 2" width="91" height="82" transform="translate(450 143)" fill="none" stroke="#707070" stroke-width="1"/>
                                                          </clipPath>
                                                        </defs>
                                                        <g id="Enmascarar_grupo_2" data-name="Enmascarar grupo 2" transform="translate(-450 -143)" clip-path="url(#clip-path)">
                                                          ...
                                                          <text id="TECNO_FUEGO-2" data-name="TECNO FUEGO" transform="translate(462 222)" font-size="18" font-family="Haettenschweiler"><tspan x="0" y="0">TECNO FUEGO</tspan></text>
                                                        </g>
                                                      </svg>
                                            ...
                                            {!! QrCode::size(140)->generate(route('component.edit', $component->id)) !!}
                                            <button class="btn btn-secondary text-white d-block center mt-4" href="#"
                                                onclick="imprimir({{ $component->id }})"><i
