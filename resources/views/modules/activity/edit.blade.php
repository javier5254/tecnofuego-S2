    ...
    <div class="row" id="contenendor">
        ...
        <div class="col-12">
            <div class="list-group">
                ...
                <a class="list-group-item list-group-item-action py-4 h6" type="button" data-toggle="modal" data-target="#generalmodal">{{ $cont }}. Información General Inicial <i class="float-right fa fa-check text-success" style="font-size:18px;"></i></a>
                {{-- Task container --}}
                <div id="containtask">
                    @foreach ($list as $l)
                    @php
                    $cont++;
                    @endphp
                    <a onclick="customModal(this.id)" id="{{ $l->id }}" class="list-group-item list-group-item-action py-4 h6">{{ $cont . '. ' . $l->name }}
                        @php
                        $cont1 = 0;
                        @endphp
                        ...
                        @else
                        <i class="float-right  {{ $a->state == 1 ? 'fa fa-check text-success' : 'fa fa-times text-danger' }}" style="font-size:18px;"></i>
                        @endif
                ...
                {{-- General information task --}}
                <a class="list-group-item list-group-item-action py-4 h6" type="button" data-toggle="modal" data-target="#generalmodal">{{ $cont }}. finalizar </a>
            </div>
        </div>
        <!-- Modal custom-->
        <div class="modal fade col-12 col-md-6 col-lg-4 mx-auto" id="customModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header bg-secondary p-3 rounded-0">
                        ...
                        <h4 class="modal-title text-white col-8 font-weight-semibold" style="text-transform: none;" id="titlemodal"></h4>
                        <h5 class="col-3">
                    ...
                    <div class="modal-body" id="content1">
                        ...
                        <p id="descriptionmodal" style="text-transform:none;" class="text-dark font-weight-semibold texto">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-secondary p-3 rounded-0">
                        ...
                        <h4 class="modal-title text-white col-9" id="exampleModalLabel">Finalizar actividad</h4>
                        <h5 class="col-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="form-group input-group mb-0">
                        ...
                        <div class="form-group input-group mb-0">
                            <input type="text" class="form-control mb-0" placeholder="Buscar.." onkeyup="searchCompo(this.value)">
                        ...
                        success: function(res) {
                            ...
                            if (val.length == 0) {
                                ...
                                for (let x = 0; x < val.length; x++) {
                                    ...
                                    complement2 += '<input type="text" disabled class="form-control mb-3" id="' + ControlFillId + '"  value="' + v14 + '">';
                                    complement2 += '<input type="hidden" class="form-control mb-3" id="item' + ControlFillId + '" value="' + itemId + '">';
                                    complement2 += '<input type="hidden" id="item_id' + compo_id + '" value="' + itemId + '">';
                                    complement2 += '<a class="btn btn-success btn-sm text-white mb-3" onclick="modalchangecompo(' + compo_id + ')"><i class="fas fa-sync-alt"></i> Cambiar</a>';
                                    complement2 += '</div>';
                                    complement2 += '</div>';
                                    complement2 += '</div>';
                                }
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            if (val == null) {
                                ...
                                complement2 = '<label>Serial</label>';
                                complement2 += '<input type="text" class="form-control mb-3" disabled value="' + val.cvalue + '">';
                                            ...
                                            if (val.length == 0) {
                                                ...
                                                for (let x = 0; x < val.length; x++) {
                                                    ...
                                                    complement2 += '<div id="coll1' + id +
                                                        ...
                                                        id + '" data-parent="#accordion2">';
                                                    complement2 += '<div class="card-body">';
                                                    complement2 += '<label>Serial/Consecutivo</label>';
                                                    complement2 += '<input type="text" class="form-control mb-3" disabled  value="' + v9 + '" >';
                                                    complement2 += '<label>Fecha PH</label>';
                                                    complement2 += '<input type="date" class="form-control mb-3 ' + v1 + '" id="ctl' + ControlFillId + '" onchange="A5(' + ControlFillId + ')"  value="' + v14 + '" >';
                                                    complement2 += '<div class="invalid-feedback mb-3">Fecha de instalación vencida</div>';
                                                    complement2 += '<div class="valid-feedback mb-3">Fecha de instalación vigente</div>';
                                                    complement2 += '<input type="hidden" class="form-control mb-3" id="item' + ControlFillId + '" value="' + itemId + '">';
                                                    complement2 += '<input type="hidden" id="item_id' + compo_id + '" value="' + itemId + '">';
                                                    complement2 += '<a class="btn btn-success btn-sm text-white mb-3" onclick="modalchangecompo(' + compo_id + ')"><i class="fas fa-sync-alt"></i> Cambiar</a>';
                                                    complement2 += '</div>';
                                            ...
                                            if (val.length == 0) {
                                                ...
                                                for (let x = 0; x < val.length; x++) {
                                                    ...
                                                    complement2 += '<div id="coll' + id +
                                                        ...
                                                        id + '" data-parent="#accordion2">';
                                                    complement2 += '<div class="card-body">';
                                                    complement2 += '<div id="alertcontainer' + ControlFillId + '"></div>';
                                                    complement2 += '<label>Serial/Consecutivo</label>';
                                                    complement2 += '<input type="text" disabled class="form-control mb-3"  value="' + v9 + '">';
                                                    complement2 += '<label>Altura QS</label>';
                                                    complement2 += '<input type="text" class="form-control mb-3" id="' + ControlFillId + '" onchange="A4(' + ControlFillId + ')" placeholder="' + v14 + '">';
                                                    complement2 += '<input type="hidden" class="form-control mb-3" id="item' + ControlFillId + '" value="' + itemId + '">';
                                                    complement2 += '<input type="hidden" id="item_id' + compo_id + '" value="' + itemId + '">';
                                                    complement2 += '<a class="btn btn-success btn-sm text-white mb-3" onclick="modalchangecompo(' + compo_id + ')"><i class="fas fa-sync-alt"></i> Cambiar</a>';
                                                    complement2 += '</div>';
                                        ...
                                        success: function(res) {
                                            ...
                                            if (val.length == 0) {
                                                ...
                                                for (let x = 0; x < val.length; x++) {
                                                    ...
                                                    complement2 += '<input type="text" class="form-control mb-3" id="ctl' + ControlFillId + '" onchange="A5(' + ControlFillId + ')"  value="' + v15 + '" >';
                                                    complement2 += '<label>Peso Estampado</label>';
                                                    complement2 += '<input type="text" disabled class="form-control mb-3" id="ctl' + ControlFillId + '" value="' + v16 + '" >';
                                                    complement2 += '<input type="hidden" class="form-control mb-3" id="item' + ControlFillId + '" value="' + itemId + '">';
                                                    complement2 += '<input type="hidden" id="item_id' + compo_id + '" value="' + itemId + '">';
                                                    complement2 += '<a class="btn btn-success btn-sm text-white mb-3" onclick="modalchangecompo(' + compo_id + ')"><i class="fas fa-sync-alt"></i> Cambiar</a>';
                                                    complement2 += '</div>';
                                        ...
                                        success: function(res) {
                                            ...
                                            if (val.length == 0) {
                                                ...
                                                for (let x = 0; x < val.length; x++) {
                                                    ...
                                                    complement2 += '<div class="card-body">';
                                                    complement2 += '<label>Seria/Consecutivo</label>';
                                                    complement2 += '<input type="text" disabled class="form-control mb-3" value="' + v14 + '">';
                                                    complement2 += '<input type="hidden" class="form-control mb-3" id="item' + ControlFillId + '" value="' + itemId + '">';
                                                    complement2 += '<input type="hidden" id="item_id' + compo_id + '" value="' + itemId + '">';
                                                    complement2 += '<a class="btn btn-success btn-sm text-white mb-3" onclick="modalchangecompo(' + compo_id + ')"><i class="fas fa-sync-alt"></i> Cambiar</a>';
                                                    complement2 += '</div>';
