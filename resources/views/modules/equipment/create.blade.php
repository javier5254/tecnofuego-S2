...
<div class="col-lg-10 offset-lg-1 col-12">
        ...
        <div class="card-body">
            <form action="{{ route('equipment.store') }}" method="POST" id="formEquipment">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="horometer" id="horometer" class="form-control {{ $errors->has('horometer') ? 'is-invalid' : '' }}">
    ...
    <div class="card">
        ...
        <h5><a href="#" data-toggle="modal" data-target="#modal2-md" class="btn btn-success btn-sm my-4 ml-4"><i class="fas fa-plus"></i> &nbsp; Agregar componente</a></h5>
                        ...
                        <div class="col-12">
                            <form action="" method="get" id="form_search">
                                <div class="form-group input-group mb-0">
                                    @csrf
                                    <div class="form-group input-group mb-0">
                                        <input id="SearchListAddCompo" type="text" class="form-control mb-0 border" placeholder="Buscar..">
    ...
    <div class="modal fade" id="modal2-md">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="d-block px-3">
                    <button type="button" class="btn btn-success btn-sm float-right" id="btnaddServ" data-dismiss="modal">Agregar</button>
