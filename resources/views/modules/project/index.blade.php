...
@section('breadcum', 'Proyectos')
@section('volver', '')
@section('content')
    <div class="col-lg-10 offset-lg-1 col-md-12">
        <a class="btn btn-success text-white mt-1" href="{{ route('project.create') }}"><i class="fas fa-plus"></i>
            Agregar Proyecto</a>
        <div class="card mt-4">
            ...
            <form action="{{ route('project.search') }}" method="get" id="form_search">
                <div class="form-group input-group mb-0">
                    @csrf
                    <div class="form-group input-group mb-0">
                        <input id="SearchProject" type="text" class="form-control mb-0" name="SearchProject"
                            placeholder="Buscar..">
            ...
            <div class="row col-12 m-0 p-0" id="contenendor">
                @forelse($projects as $project)
                    <a href="{{ route('project.edit', $project->id) }}" class="card-body border bottom col-12">
                        <div class="row">
                            <div class="col-10">
                                <h3 style="mb-0"><small>{{ ucwords($project->name) }}</small></h3>
                                <p class="mb-0"> {{ $project->state ? 'Activo' : 'Inactivo' }} </p>
                            </div>
                            <div class="col-2">
                                <p class="float-right">
