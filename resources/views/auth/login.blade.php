                ...
                <div class="card-body">
                    <div class="" style="text-transform: none;overflow:auto;">
                        <center>
                            ...
                            <svg style="width: auto;height:auto;"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="334" height="103" viewBox="0 0 334 103">
                                <defs>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            <div class="input-group auth-pass-inputgroup">
                                <x-jet-input id="password" class="form-control" type="password" name="password" required
                                placeholder="Contraseña" autocomplete="current-password" />
                                <a class="end pointer p-3" onclick="mostrarContrasena()">
                                    <i class="ti-eye input-group-append"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-12 p-0">
                            <label for="remember_me" class="flex items-center">
                                ...
                                <small class="text-custom m-0 p-0">{{ __('Recordarme') }}</small>
                            </label>
