...
@section('breadcum', 'Actualizar contraseña')
@section('volver', 'si')
@section('content')
                ...
                <div class="my-3 overflow-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="420"
                        ...
                        <g id="Grupo_237" data-name="Grupo 237" transform="translate(-460 -154.5)">
                            ...
                            <text id="TECNO_FUEGO" data-name="TECNO FUEGO" transform="translate(472.5 179.5)" fill="#707070"
                                stroke="#707070" stroke-width="1" font-size="23"
                            ...
                            <text id="Sistema_de_Registro_de_Actividades_y_Componentes_SIRAC"
                                ...
                                <tspan x="0" y="0" xml:space="preserve">Sistema de Registro de Actividades y Componentes SIRAC</tspan>
                            </text>
                        </g>
                    </svg>
